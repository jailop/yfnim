...
##
## A fast, Unix-friendly tool for retrieving stock market data from Yahoo Finance
## Built with cligen for automatic argument parsing and help generation
  ...
  dispatchMulti(
    ...
    [quote_cmd, cmdName = "quote",
     help = {
       ...
       "precision": "Decimal places",
       "date_format": "Date display format",
       "read_stdin": "Read symbols from stdin (cat list.txt | yf quote --read_stdin)"
     }],
